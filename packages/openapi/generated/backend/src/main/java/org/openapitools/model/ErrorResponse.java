...
public class ErrorResponse {
   ...
   */
  public ErrorResponse(String code, String message, UUID requestId, OffsetDateTime timestamp) {
    this.code = code;
  ...
  public ErrorResponse requestId(UUID requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, message, requestId, timestamp);
  }
